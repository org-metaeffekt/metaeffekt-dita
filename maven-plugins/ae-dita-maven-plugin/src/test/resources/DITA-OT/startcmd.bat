...
set CLASSPATH=%DITA_DIR%lib;%DITA_DIR%lib\dost.jar;%DITA_DIR%lib\resolver.jar;%DITA_DIR%lib\fop.jar;%DITA_DIR%lib\avalon-framework-cvs-20020806.jar;%DITA_DIR%lib\batik.jar;%DITA_DIR%lib\saxon.jar;%DITA_DIR%lib\saxon65.jar;%DITA_DIR%lib\xml-apis.jar;%DITA_DIR%lib\icu4j.jar;%DITA_DIR%lib\xslthl-2.0.0.jar;%DITA_DIR%lib\fonts.jar;%DITA_DIR%lib\fop-hyph.jar;%CLASSPATH%
